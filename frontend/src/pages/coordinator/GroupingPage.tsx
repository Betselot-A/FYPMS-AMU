...
const calculateAutoGroups = (students: User[], maxSize: number) => {
  ...
  Object.entries(byDept).forEach(([dept, deptStudents]) => {
    ...
    for (let i = 0; i < sorted.length; i += maxSize) {
      groups.push({
        department: dept,
        members: sorted.slice(i, i + maxSize),
      });
    }
  });
                ...
                <div className="space-y-4 py-4">
                  ...
                  <div className="space-y-2">
                    <label className="text-xs font-black uppercase tracking-widest text-muted-foreground">
                      Select Members (Max {maxGroupSize})
                    </label>
            ...
            <Card className="shadow-card">
              <CardContent className="p-4 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-muted-foreground mt-0.5 border-t border-border pt-0.5">Max {maxGroupSize}/group</p>
                </div>
              </CardContent>
            </Card>
            <Card className="shadow-card">
