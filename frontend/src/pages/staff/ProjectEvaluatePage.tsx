// ============================================================
// Project Evaluate Page (Examiner context)
// Per-member presentation-based evaluation criteria
// ============================================================
...
import { ArrowLeft, Send, User, ChevronDown, ChevronRight } from "lucide-react";
...
const maxTotal = criteria.reduce((sum, c) => sum + c.max, 0); // 20
...
const ProjectEvaluatePage = () => {
  ...
  return (
    <div>
      ...
      <h1 className="text-xl font-display font-bold text-foreground mb-1">Evaluate Project</h1>
            ...
            <Card key={m!.id} className="shadow-card">
              ...
              {isExpanded && (
                <CardContent className="space-y-3 pt-0">
                  ...
                  <Textarea
                    placeholder="Comments for this student (optional)..."
                    value={comments[m!.id] || ""}
